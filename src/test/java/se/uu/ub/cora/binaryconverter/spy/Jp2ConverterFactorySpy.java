...
public class Jp2ConverterFactorySpy implements Jp2ConverterFactory {

	public MethodCallRecorder MCR = new MethodCallRecorder();
	public MethodReturnValues MRV = new MethodReturnValues();

	public Jp2ConverterFactorySpy() {
		MCR.useMRV(MRV);
		MRV.setDefaultReturnValuesSupplier("factor", Jp2ConverterSpy::new);
	}
